...
export function PembayaranHutang({
  className,
  company,
  project,
  year,
  ...
  const get = async () => {
    const url = `${api_url}/api/accounting/v1/pembayaranhutang?company=${company}&project=${project}&year=${year}&month=${month}`;
    try {
  ...
  return (
    <div className={`card card-custom ${className}`}>
      {/* Head */}
      <div className="card-header text- border pt-5 d-flex justify-content-center">
