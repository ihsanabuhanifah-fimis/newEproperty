...
function PenerimaanKPR({ company, project, year, month, headers, api_url }) {
  ...
  const get = async () => {
    const url = `${api_url}/api/finances/v1/penerimaankpr?company=${company}&project=${project}&year=${year}&month=${month}`;
